                ...
                <div className="container">
                    <div className="row justify-content-center">
                        ...
                        <div className="col-12 text-center mt-5">
                            <h1 className="display-md-6 display-5 fst-italic mb-2 animate__animated animate__slideInDown text-secondary">
                                {t("title")}
                            </h1>
                            <p className="mb-3  display-6 fw-normal mb-md-5 animate__animated animate__slideInDown text-secondary">{t("subtitle")}
                            </p>
                            {/*<Link to="/about"*/}
